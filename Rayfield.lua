...
local Icons = useStudio and require(script.Parent.icons) or loadWithTimeout('https://raw.githubusercontent.com/axleoislost/Rayfield/refs/heads/main/Icons.lua')
-- Variables
